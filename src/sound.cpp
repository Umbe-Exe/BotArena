...
void playLaserSound() {
	al_play_sample(laserSound, 1.f, 0.f, 1.f, ALLEGRO_PLAYMODE_ONCE, 0);
}
...
void playMissileSound() {
	al_play_sample(missileSound, 0.2f, 0.f, 1.f, ALLEGRO_PLAYMODE_ONCE, 0);
}
...
void playBotCollisionSound() {
	al_play_sample(botCollisionSound, 0.2f, 0.f, 1.f, ALLEGRO_PLAYMODE_ONCE, 0);
}
